...
def principal():
    ...
    st.subheader("Este app permite integração de processamento de imagens com OpenCV")
    ...
    img_erosao = st.sidebar.checkbox("Filtro Erosao")
    ...
    st.text("Imagem Original vc Imagem Processada")
